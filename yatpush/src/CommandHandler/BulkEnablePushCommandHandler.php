...
/**
 * Class BulkEnablePushCommandHandler is responsible for enabling cms category pages.
 */
final class BulkEnablePushCommandHandler implements BulkEnablePushCommandHandlerInterface
{
     ...
     */
    public function handle(BulkEnablePushCommand $command)
    {
        try {
            ...
            throw new PushException('Unexpected error occurred when handling bulk enable push', 0, $e);
        }
    }
}
