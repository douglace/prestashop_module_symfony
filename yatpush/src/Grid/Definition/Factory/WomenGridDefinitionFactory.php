...
class WomenGridDefinitionFactory extends AbstractGridDefinitionFactory
{
    ...
    {
        return $this->trans('Women', [], 'Modules.Yatpush.Admin');
    }
        ...
        return (new ColumnCollection())
            ...
            ->add(
                ...
                ->setOptions([
                    ...
                    'update_route' => 'yatpush_pushwomen_update_positions',
                    'update_method' => 'POST',
                    'record_route_params' => [
            ...
            ->add( 
                (new ToggleColumn('active')) 
                    ...
                    ->setOptions([ 
                        ...
                        'route' => 'yatpush_pushwomen_toggle_status', 
            ...
            ->add( 
                ...
                ->setOptions([ 
                    ...
                    ->add( 
                        ...
                        ->setIcon('delete') 
                        ->setOptions([ 
                            'route' => 'yatpush_pushwomen_delete', 
                            'route_param_name' => 'pushId', 
                            'route_param_field' => 'id_yateo_push', 
            ...
            ->add(
                ...
                (new Filter('actions', SearchAndResetType::class))
                    ->setTypeOptions([
                        ...
                        'redirect_route' => 'yatpush_pushwomen',
                    ])
        ...
        return (new GridActionCollection())
            ->add(
                (new LinkGridAction('export'))
                    ...
                    ->setOptions([
                        'route' => 'yatpush_pushwomen_export',
                    ])
            )
    ...
    protected function getBulkActions()
    {
        return (new BulkActionCollection())
            ->add((new SubmitBulkAction('enable_selection'))
                ...
                ->setOptions([
                    'submit_route' => 'yatpush_pushwomen_bulk_status_enable',
                ])
            )
            ->add((new SubmitBulkAction('disable_selection'))
                ->setName($this->trans('Disable selection', [], 'Admin.Actions'))
                ->setOptions([
                    'submit_route' => 'yatpush_pushwomen_bulk_status_disable',
                ])
            )
            ->add(
                $this->buildBulkDeleteAction('yatpush_pushwomen_delete_bulk')
            )
        ;
    }
