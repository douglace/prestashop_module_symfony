...
class Repository
{
    ...
    public static $extra_desc_table = 'dfc_extra_field_categories';
    ...
    public function installDatabase()
    {
        ...
        $sql[] = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'dfc_extra_field_categories` (
    ...
    protected function registerHooks()
    {
        ...
        $this->module->registerHook('actionCategoryFormBuilderModifier') &&
        $this->module->registerHook('actionAfterUpdateCategoryFormHandler') &&
        $this->module->registerHook('actionAfterCreateCategoryFormHandler') &&
