...
namespace Juba\Diliosfieldcat\Classes;
...
class Manager extends ObjectModel
{
     ...
     * @param string $title
     */
    public static function storeExtrafieldValues($categoryId, $desc, $title, $shopId = null, $langId = null)
    {
        $langId  = $langId ? $langId : Context::getContext()->language->id;
        $shopId  = $shopId ? $shopId : Context::getContext()->shop->id;

        if (self::exists($categoryId, $shopId, $langId)) {
     ...
     */
    public static function exists($categoryId, $shopId, $langId)
    {
        $q = new DbQuery();
        $q->select('1')
     ...
     */
    public static function getExtrafieldValues($categoryId, $shopId, $langId)
    {
        $q = new DbQuery();
