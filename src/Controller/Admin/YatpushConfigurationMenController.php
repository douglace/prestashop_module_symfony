...
use Yateo\Yatpush\Grid\Definition\Factory\MenGridDefinitionFactory;
use PrestaShopBundle\Component\CsvResponse;
use Yateo\Yatpush\Grid\Filters\MenFilters;
...
class YatpushConfigurationMenController extends FrameworkBundleAdminController 
{ 
    use CommonPushTrait;
     ...
     * @return void 
     */ 
    public function indexAction(Request $request, MenFilters $filters) 
    { 
        $menGridFactory = $this->get('yatpush.grid.grid_factory.men');
        $menGrid = $menGridFactory->getGrid($filters);
        
        return $this->render(
            '@Modules/yatpush/views/templates/admin/men.html.twig',
            [
                'enableSidebar' => true,
                'layoutHeaderToolbarBtn' => $this->getToolbarButtons(),
                'layoutTitle' => $this->trans('Men push listing', 'Modules.Yatpush.Admin'),
    ...
    public function searchAction(Request $request)
    {
        ...
        return $responseBuilder->buildSearchResponse(
            $this->get('yatpush.grid.definition.factory.men'),
            $request,
    ...
    public function createAction(Request $request)
    {
        ...
        $pushForm = $pushFormBuilder->getForm(['type' => "MAN"], []);
    ...
    public function deleteImageAction($pushId)
    {
        ...
        return $this->redirectToRoute('yatpush_pushmen_edit', [
            'pushId' => $pushId
        ]);
    }
    ...
    public function updatePositionsAction(Request $request)
    {
        ...
        try {
            $repository->updatePositions('MAN', $positionsData);
    ...
    public function exportAction(MenFilters $filters)
    {
        $filters = new MenFilters(['limit' => null] + $filters->all());
    ...
    { 
        return [ 
            'add' => [ 
                ...
                'href' => $this->generateUrl('yatpush_pushmen_create'), 
            ], 
            'women' => [ 
                'desc' => $this->trans('Women list', 'Modules.Yatpush.Admin'), 
                'icon' => 'list',
                'href' => $this->generateUrl('yatpush_pushwomen'), 
