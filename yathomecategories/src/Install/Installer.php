...
class Installer 
{
    public $tabs = [ 
        [ 
            ...
            'icon' => 'book', 
            'wording' => 'Yateo', 
            'wording_domain' => 'Modules.Yathomecategories.Admin', 
        ], 
        [ 
            'class_name' => 'AdminYHMenCategory', 
            'parent_class_name' => 'AdminYatPushCategory', 
            'name' => 'Catégories homme',  
            'icon' => 'list', 
            'wording' => 'Catégories homme', 
            'wording_domain' => 'Modules.Yathomecategories.Admin', 
        ], 
        [ 
            'class_name' => 'AdminYHWomenCategory', 
            'parent_class_name' => 'AdminYatPushCategory', 
            'name' => 'Catégories femme', 
            'icon' => 'list', 
            'wording' => 'Catégories femme', 
            'wording_domain' => 'Modules.Yathomecategories.Admin', 
        ], 
    ];
